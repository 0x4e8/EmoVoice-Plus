...
def main(kwargs: DictConfig):
    ...
    # m = model
    # if rank == 0:
    #     print("has align_text_proj:", hasattr(m, "align_text_proj"))
    #     if hasattr(m, "align_text_proj") and m.align_text_proj is not None:
    #         print("requires_grad(weight):", m.align_text_proj.weight.requires_grad)
    ...
    dataset_train = get_preprocessed_dataset(    # dataset_train.data_list[0]
        tokenizer,
        dataset_config,
        split="train",
    )
    ...
    if fsdp_config.pure_bf16 and fsdp_config.optimizer == "anyprecision":
        ...
        # if rank == 0 and hasattr(m, "align_text_proj") and m.align_text_proj is not None:
        #     target = m.align_text_proj.weight
        #     in_optim = any(target is p for g in optimizer.param_groups for p in g["params"])
        #     print("align_text_proj.weight in optimizer:", in_optim)
