...
llm_path="/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/ckpt/ckpts/Qwen/Qwen2.5-0.5B"
codec_decoder_path="/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/ckpt/ckpts/CosyVoice/CosyVoice-300M-SFT"
phn_tokenizer="/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/ckpt/Qwen2.5-0.5B-phn"
ckpt_path=/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/ckpt
split=test
val_data_path=/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/EmoVoice-DB/test_mini_happy.jsonl
# vocabulary settings
...
# decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_kaiyuan_CE_and_Align_epoch-10-32_1_0.5-test700 #-sad-0.012-new10
# decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_kaiyuan_ppmodel-test700
# decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_kaiyuan_CE_and_Align_16-2-0.5_epoch-40_test700
decode_log=$ckpt_path/tts_decode_${split}_rp${repetition_penalty}_seed${dataset_sample_seed}_greedy_kaiyuan_CE_and_Align_epoch-40-hayppy100

# tmp_ckpt_path=/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/debug2/tts_epoch_75_step_2631/model.pt
tmp_ckpt_path=/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/debug_CE_and_Align/tts_epoch_40_step_1973/model.pt
# tmp_ckpt_path=/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/debug_CE_and_Align_0.5align_32_1/tts_epoch_10_step_1973/model.pt

steering_path=/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/tools/happy_steering_activations_random.pt
style_emb_pt="/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/EmoVoice-DB/train_and_val.style_emb.pt"
...
python $code_dir/inference_tts.py \
        ...
        ++decode_config.emosteer.enable=false \
        ++decode_config.emosteer.steering_path=$steering_path \
        ++decode_config.emosteer.steering_strength=0.015 \
        ++decode_config.emosteer.num_steps=10 \
        ++decode_config.emosteer.erasing_strength=0.0 \
        ++decode_config.emosteer.block_group=5 \
        ++train_config.align.enable=true \
        ++train_config.align.style_emb_pt=$style_emb_pt \
        ++train_config.align.loss_weight=0.5 \
    ...
    # ++decode_config.emosteer.layers=[0,5,10,15,20,25,30,35,40,45,50,55,60]
