...
# dataset settings
train_data_path="/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/EmoVoice-DB/train.jsonl"
val_data_path="/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/EmoVoice-DB/val.jsonl"

# training settings
batch_size_training=12 # 6
use_fp16=true
use_peft=false
num_epochs=400
lr=1e-5
warmup_steps=1000
total_steps=200000 # 100000

# validation settings
validation_interval=13155 # 2500 15786 2631
split_size=0.01
# model settings
group_decode=true
...
home_dir=/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice
output_dir=$home_dir/$exp_name
ckpt_path=/data/home/zdhs0047/zdhs0047_src_data/zengfanshuo/EmoVoice/ckpt # this line is for resuming training
...
++ckpt_path=$ckpt_path/0.5b-pp_model.pt \
"
